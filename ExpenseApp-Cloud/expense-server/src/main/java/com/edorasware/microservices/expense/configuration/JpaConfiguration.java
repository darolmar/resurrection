package com.edorasware.microservices.expense.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.edorasware.microservices.expense.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.edorasware.microservices.expense.model" });
